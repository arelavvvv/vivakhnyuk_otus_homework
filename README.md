...
---
Используемая версия [golangci-lint](https://golangci-lint.run/usage/install/#other-ci): <b>v1.60.1</b>
```
$ golangci-lint version
golangci-lint has version 1.60.1 built with go1.22.1 from 77a8601a on 2024-03-28T19:01:11Z
```
